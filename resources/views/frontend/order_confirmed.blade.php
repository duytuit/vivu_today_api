                            ...
                            <div class="col-md-6">
                                <table class="table fs-14 text-soft-dark">
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-top-0 py-2">{{ json_decode($first_order->shipping_address)->address }}, {{ Config::get('app.locale') == 'vn' ? '' : json_decode($first_order->shipping_address)->city }}, {{ json_decode($first_order->shipping_address)->country }}</td>
                                    </tr>
                                </table>
                            </div>
                            <div class="col-md-6">
